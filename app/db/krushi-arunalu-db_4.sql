...
--
-- Host: localhost:8889
-- Generation Time: Jan 23, 2023 at 08:28 PM
...
INSERT INTO `customer_inquiry` (`id`, `date_time`, `content`, `response_date_time`, `response_content`, `customer_id`, `product_id`) VALUES
(1, '2015-12-22 03:30:44', 'bubb', NULL, NULL, 7, 1),
(2, '2015-12-22 03:31:32', 'bubb', NULL, NULL, 7, 1),
(3, '2015-12-22 04:07:55', '', NULL, NULL, 7, 1),
(4, '2015-12-22 04:36:48', '', NULL, NULL, 7, 5),
(5, '2015-12-22 04:43:07', '', NULL, NULL, 7, 1),
(6, '2016-12-22 03:50:37', 'euiui', NULL, NULL, 7, 1),
(7, '2023-01-23 08:06:41', 'jvjv', NULL, NULL, 7, 1);
...
ALTER TABLE `customer_inquiry`
  ADD PRIMARY KEY (`id`),
  ADD KEY `inquiry_customer_id` (`customer_id`),
  ADD KEY `inquiry_product_id` (`product_id`);
...
--
-- Constraints for table `customer_inquiry`
--
ALTER TABLE `customer_inquiry`
  ADD CONSTRAINT `inquiry_customer_id` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`),
  ADD CONSTRAINT `inquiry_product_id` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);
