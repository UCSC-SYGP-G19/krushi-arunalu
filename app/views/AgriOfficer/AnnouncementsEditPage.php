                    ...
                    <div class="form-wrapper px-2">
                        <div class="row px-1 pt-1">
                            <div class="col-12 wrapper px-3 py-3">
                                <h2 class="title mt-2 py-1 text-center"> Edit Announcement</h2>
                                <form class=" mt-2 mb-1 px-2" action="" method="post">

                                    <div class="row gap-2">
                                        <?php
                                        $this->formData = [ //creating an associative array
                                            "announcement_title" => [
                                                ...
                                                "type" => "text",
                                                "value" => $this->data->announcement_title,
                                            ],
                                            "announcement_content" => [
                                                ...
                                                "rows" => 4,
                                                "cols" => 12,
                                                "value" => $this->data->announcement_content,
                                            ]
                                        ];
