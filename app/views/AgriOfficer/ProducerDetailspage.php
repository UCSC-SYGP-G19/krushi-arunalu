...
?>
                ...
                <div class="content p-4 mt-1">
                    <div class="container-fluid px-2">
                        <div class="row px-1 pt-1 justify-content-space-between">
                            <div class="col-6">
                                <h1 class="title">Producers in district</h1>
                            </div>
                        </div>
                        <div class="row px-1 pt-2">
                            <div class="col-12 text-justify">
                                <br>
                                <section id="producers-section"></section>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?php echo URL_ROOT ?>/public/js/AgriOfficer/producerDetails.js" defer></script>
    </body>
