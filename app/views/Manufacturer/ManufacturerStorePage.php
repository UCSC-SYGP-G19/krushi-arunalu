...
//        ?>
        <main class="content overflow-y-auto">
            ...
            <div class="content-wrapper manufacturer-store-wrapper py-2">
                <div class="row store-info-wrapper p-2">
                    <div class="pb-2">
                        <button class="btn-outlined-secondary fs-3 fw-bold" onclick="history.back()">Back</button>
                    </div>
                    <div class="store-cover col-12 pt-1">
                        <?php
                            echo '<img class="col-12" alt="Cover Image" height="100%" width="100%" src="' . URL_ROOT .
                            '/public/img/manufacturer/' . $this->data["manufacturer"]->cover_image . '"' . '>'
                        ?>
                    </div>
                            ...
                            <div class="row col-12 d-flex">
                                <div class="company-logo col-3">
                                    <?php echo
                                        ...
                                        ' . URL_ROOT . '/public/img/manufacturer/company_logo.png"' . '>'
                                    ?>
                                </div>
                                <div class="company-details col-9 p-3">
                                    ...
                                    <div class="col-12 d-flex pb-3">
                                        <div class="col-6 text-left contact-info d-flex align-items-center fw-bold">
                                            <span class="icon">
                                                <?php echo
                ...
                <div class="category-selector row col-12 px-2">
