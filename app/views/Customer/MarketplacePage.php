                                ...
                                <div class="product-card  p-3 pb-2">
                                    ...
                                    . $product->unit_selling_price . '</h4>
                                        <div class="row gap-1">
                                            ...
                                            <div class="col-7">
                                                <button class="btn-primary-light text-white"><svg class="pb-1" width="45" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
