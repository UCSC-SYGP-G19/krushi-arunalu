<nav class="navbar logged-in-navbar">
    <div class="col-3 pt-1">
        <a href="/krushi-arunalu/login">
            <img class="brand-logo-large" src="<?php echo URL_ROOT ?>/public/img/navbar-logo-large.webp" alt="logo"
                 height="72px">
        </a>
    </div>
    ...
    <div class="col-6 col-4-lg text-center pt-1">
        <div class="row">
                    ...
                    <div class="position-relative">
                        ...
                        <div id="notifications-panel">
                            <div class="pt-2 pb-4 px-2 justify-content-center text-center">
                                <img src="<?php echo URL_ROOT ?>/public/img/other/no-notifications.gif"
                                     alt="Sleeping bell"
                                     width="240px">
            ...
            <!--                </div>-->
            <!--            </div>-->
            <div class="col-4 text-right pb-1 px-2 m-auto">
                <?php
                try {
