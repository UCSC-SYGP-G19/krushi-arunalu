...
const fetchReceivedRequests = async () => {
  const res = await fetch(`${URL_ROOT}/connectionRequests/getReceivedRequestsAsJson`);
  if (res.status === 200) {
    console.log(res);
...
const fetchSentRequests = async () => {
  const res = await fetch(`${URL_ROOT}/connectionRequests/getSentRequestsAsJson`);
  if (res.status === 200) {
                            ...
                            <div class="row">
                                <div class="col-1 text-align-center justify-content-center pt-1">
                                    <img class="avatar m-auto" alt="User avatar"
                                         src="${URL_ROOT}/img/user-avatars/${element.sender_image_url}"/>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-9">
                            <div class="row">
                                <div class="col-1 text-align-center justify-content-center pt-1">
                                    <img class="avatar m-auto" alt="User avatar"
                                         src="${URL_ROOT}/img/user-avatars/${element.receiver_image_url}"/>
                                </div>
